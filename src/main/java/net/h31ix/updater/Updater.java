...
public class Updater
{
	...
	UPDATE_AVAILABLE,
	/**
	 * The updater found an update, but because of the wrong MC Version it wasn't downloaded
	 */
	...
	if(type != UpdateType.NO_VERSION_CHECK)
	{
	    ...
	    if (!title.contains("[MC Version " + ( (SilkSpawners) plugin).compatibleMinecraftVersion + "]"))
	    {
		...
		plugin.getLogger().warning("The update was NOT downloaded, you might want to upgrade your Minecraft version instead!");
		result = Updater.UpdateResult.WRONG_MINECRAFT_VERSION;
		return false;
	    }
