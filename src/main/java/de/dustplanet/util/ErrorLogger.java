...
//
//import net.minecraft.server.v1_6_R1.CrashReport;
...
//                        )
//                );
//                report.a(dump, MinecraftServer.getServer().getLogger());
...
//        return ser != null ? (JSONObject) JSONValue.parse(ser) : new HashMap<String, String>();
//    }
// 
//    static {
//        try {
