package de.dustplanet.silkspawners.compat.v1_6_R1;
...
public class NMSHandler implements NMSProvider {
    ...
    public void setSpawnersUnstackable() {
        ...
        try {
            ...
            Bukkit.getLogger().warning("Failed to set max stack size, ignoring spawnersUnstackable: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public ItemStack setNBTEntityID(ItemStack item, short entityID, String entity) {
        ...
        net.minecraft.server.v1_6_R1.ItemStack itemStack = null;
